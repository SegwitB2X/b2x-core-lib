# Public Key
Represents a Segwit2X public key and is needed to be able to receive B2X, as is usually represented as a bitcoin [Address](address.md). 

A PublicKey in core is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).

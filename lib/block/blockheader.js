...
var HARDFORK_VERSION = 671088640;
...
BlockHeader._fromBufferReader = function _fromBufferReader(br) {
  ...
  if (info.version === HARDFORK_POS_VERSION) {
...
BlockHeader.prototype.toBufferWriter = function toBufferWriter(bw) {
  ...
  if (this.version === HARDFORK_POS_VERSION) {
...
BlockHeader.prototype._getHash = function hash() {
  ...
  if (HARDFORK_VERSION === this.version || this.version === HARDFORK_POS_VERSION) {
      return Hash.x11(buf);
  }
